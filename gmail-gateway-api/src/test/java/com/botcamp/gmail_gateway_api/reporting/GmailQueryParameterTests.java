...
class GmailQueryParameterTests {
    ...
    @Test
    void valid_to_string_without_dates() {
    ...
    @Test
    void valid_to_string_without_from() {
    ...
    @Test
    void valid_to_string_with_subjct_only() {
